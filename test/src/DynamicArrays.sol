...
// Ran from test directory: echidna . --contract DynamicArrays --test-mode assertion --test-limit 100000 --corpus-dir corpus-dyn-arr --crytic-args "--foundry-ignore-compile"
// Ran from test directory: test-generator ./src/DynamicArrays.sol --corpus-dir corpus-dyn-arr --contract "DynamicArrays" --test-directory "./test/" --inheritance-path "../src/" --fuzzer echidna
